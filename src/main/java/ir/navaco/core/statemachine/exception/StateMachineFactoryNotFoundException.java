...
public class StateMachineFactoryNotFoundException extends RuntimeException {
    private String resourceName;
    private String fieldName;
    private Object fieldValue;

    public StateMachineFactoryNotFoundException(String resourceName, String fieldName, Object fieldValue) {
